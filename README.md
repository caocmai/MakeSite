...
[![Go Report Card](https://goreportcard.com/badge/github.com/caocmai/MakeSite)](https://goreportcard.com/report/github.com/caocmai/MakeSite)
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: `I will use the blackfriday library. The documentation is located at https://github.com/russross/blackfriday. My goal is to use it to convert .md files to .html files.`
- [x] **Add, commit, and push to GitHub**.
